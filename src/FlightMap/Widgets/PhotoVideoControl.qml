    ...
    ColumnLayout {
        ...
        /* Rectangle {
            ...
            radius:             _isShootingInCurrentMode ? 0 : width * 0.5
                color:            qgcPal.colorGrey // _canShootInCurrentMode ? qgcPal.colorRed : qgcPal.colorGrey
            }
...
*/
            ...
            GridLayout {
                ...
                QGCLabel { text: qsTr("Altitude Relative:") }
                QGCLabel { text: (_activeVehicle.altitudeRelative.value.toFixed(2)) + ' m'}
                QGCLabel { text: qsTr("Ground speed:") }
                QGCLabel { text: (_activeVehicle.groundSpeed.value.toFixed(2)) + ' m/s'}
                QGCLabel { text: qsTr("pitch:") }
                QGCLabel { text: (_activeVehicle.pitch.value.toFixed(2)) + ' deg'}
                QGCLabel { text: qsTr("roll:") }
                QGCLabel { text: (_activeVehicle.roll.value.toFixed(2)) + ' deg'}
            }
